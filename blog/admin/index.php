...
$query = "SELECT id, title, category_id FROM posts WHERE author_id=$curent_user_id ORDER BY id DESC";
...
<?php elseif(isset($_SESSION['delete-post-success'])): ?>
    ...
    <div class="container dashboard-container">
        ...
        <button id="hide-sideber-btn" class="sidebar-toggle"><i class="uil uil-angle-left-b"></i></button>
        <aside>
            <ul>
                <li>
